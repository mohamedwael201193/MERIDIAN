...
export default function ProtocolStats() {
  ...
  return (
    <div className="mt-8 grid gap-3 sm:grid-cols-2 lg:grid-cols-4">
      ...
      />
      <StatCard label="Estimated APY" value={isLoading ? '…' : formatApy(kpis.estimatedApyBps)} />
      <StatCard label="Compliant holders" value={isLoading ? '…' : String(kpis.compliantHolders)} />
      <StatCard
