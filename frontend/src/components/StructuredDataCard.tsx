    ...
    return (
      <Stack gap={1.5}>
        {data.slice(0, 12).map((item, index) => (
          <Paper key={`${parentKey}-${index}`} variant="outlined" sx={{ p: 1.5, bgcolor: 'background.default' }}>
...
export default function StructuredDataCard({
  ...
  if (!data) {
    return (
      <Paper variant="outlined" sx={{ p: 2.5, bgcolor: 'background.default', borderColor: 'divider' }}>
